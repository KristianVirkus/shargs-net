namespace Shargs.Mapping
{
    ...
    public sealed class ShortOptionAttribute : Attribute, IMappableAttribute
    {
        #region --- Properties ---
        ...
        /// <summary>
        /// Gets whether the character is case-sensitive.
        /// </summary>
        ...
        /// <param name="IsCaseSensitive">true if the <paramref name="character"/> is
        ...
        public ShortOptionAttribute(char character, string Prefix = "-|/",
            bool IsCaseSensitive = false, string OptionValueSeparators = "| |=|:",
        ...
        {
            var ownAttributes = attributes.OfType<ShortOptionAttribute>();
            foreach(var att in ownAttributes)
            {
                node.SchemaElements.Add(new Schema.ShortOption(att.Character, att.Prefixes, att.IsCaseSensitive, att.QuotationMarks));
            }
